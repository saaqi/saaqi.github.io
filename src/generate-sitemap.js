...
import { data } from '../src/app.js'; // adjust if needed
  ...
  function walk(currentPath) {
    ...
    for (const entry of entries) {
      ...
      if (entry.isDirectory()) {
        ...
        let route = path.relative(dir, entryPath)
          .replace(/index\.html$/, '')
          .replace(/\.html$/, '');
...
fs.writeFileSync('build/sitemap.xml', sitemap); // Adjust for your output dir
