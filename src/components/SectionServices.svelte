...
<section id="services" class="section services {$darkTheme ? 'dark' : 'light'}">
	<div class="container">
		...
		<div class="draggableOuterContainer">
			<div use:draggableContainer={{ sensitivity: 2 }} id="servicesContainer" class="servicesContainer row g-2 draggableContainer pb-lg-0 pb-3">
				{#each services as { title, copy, more, iconsList }, index ('service-' + index)}
